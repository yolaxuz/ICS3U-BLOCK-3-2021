...
public class DoubleArraySequence {
    ...
    public DoubleArraySequence(int initialCapacity) throws IllegalAccessException {
        if (initialCapacity < 0 )
        throw new IllegalAccessException("Only positive capacities allowed."); 
     ...
     **/
    public void advance() throws IllegalAccessException {
        if (!isCurrent())
        throw new IllegalAccessException("No current element!"); 
        currentIndex++; 
    }
